...
const NAV_ITEMS = [
    { id: 'dashboard', icon: LayoutDashboard, label: 'Tableau de bord', description: 'Vue d\'ensemble des performances' },
    { id: 'leads', icon: Users, label: 'Prospects', description: 'Gérer les créateurs' },
    { id: 'config', icon: Settings, label: 'Configuration', description: 'Modifier les questions' },
    /* { id: 'data', icon: Database, label: 'Data' }, // Future */
];

export function OrbitalRail({ activeTab, onTabChange, onClose }: OrbitalRailProps) {
    return (
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={cn(
                                ...
                                isActive ? "bg-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)]" : "group-hover:bg-white/5"
                            )} />
                            ...
                            <div className="absolute left-full ml-4 px-3 py-2 bg-zinc-900 border border-white/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
                                ...
                                <div className="text-[10px] text-zinc-500 whitespace-nowrap mt-0.5">{item.description}</div>
                            </div>
                        </button>
                    );
                })}
