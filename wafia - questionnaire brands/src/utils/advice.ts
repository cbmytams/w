...
export function generateAdvice(
    ...
    const northStar = (answers['b_north_star'] || answers['ql_objective'] || 'unknown') as string;
...
function getWeaknessAdvice(weakness: PillarKey): AdviceItem | null {
    const adviceMap: Record<string, AdviceItem> = {
        STRATEGY: {
            ...
            kind: 'priority',
            severity: 'high',
            evidence: { questionId: 'b_north_star', question: 'Objectif stratégique', answer: '-' },
        },
        CONTENT: {
            id: 'weakness_content',
            pillar: 'CONTENT',
            ...
            kind: 'priority',
            severity: 'high',
            evidence: { questionId: 'e_production', question: 'Types de contenu à produire', answer: '-' },
        },
        ACTIVATION: {
            ...
            kind: 'priority',
            severity: 'medium',
            evidence: { questionId: 'c_channels', question: 'Canaux actifs', answer: '-' },
        },
        DATA: {
            id: 'weakness_data',
            pillar: 'DATA',
            ...
            kind: 'priority',
            severity: 'high',
            evidence: { questionId: 'c_measurement', question: 'Outils de mesure', answer: '-' },
        },
        ORGANIZATION: {
            ...
            kind: 'priority',
            severity: 'medium',
            evidence: { questionId: 'h_team_size', question: 'Taille de l\'équipe marketing', answer: '-' },
        },
    };
...
function getNorthStarQuickWin(northStar: string): AdviceItem | null {
    const quickWins: Record<string, AdviceItem> = {
        awareness: {
            ...
            kind: 'quick_win',
            severity: 'medium',
            evidence: { questionId: 'b_north_star', question: 'North Star', answer: 'Notoriété' },
        },
        traffic: {
            id: 'qw_traffic',
            pillar: 'ACTIVATION',
            ...
            kind: 'quick_win',
            severity: 'medium',
            evidence: { questionId: 'b_north_star', question: 'North Star', answer: 'Trafic' },
        },
        conversion: {
            id: 'qw_conversion',
            pillar: 'ACTIVATION',
            ...
            kind: 'quick_win',
            severity: 'medium',
            evidence: { questionId: 'b_north_star', question: 'North Star', answer: 'Conversion' },
        },
        retention: {
            id: 'qw_retention',
            pillar: 'STRATEGY',
            ...
            kind: 'quick_win',
            severity: 'low',
            evidence: { questionId: 'b_north_star', question: 'North Star', answer: 'Fidélisation' },
        },
    };
