...
export const TALENT_PILLARS: TalentPillar[] = [
  {
    ...
    description:
      "On clarifie ce que tu représentes, ton univers visuel et ta ligne éditoriale. Une identité lisible qui attire les bons deals.",
  },
  {
    id: "production",
    icon: "⚡",
    ...
    description:
      "Séries récurrentes, workflow optimisé, backlog d'idées. De 8h par vidéo à une routine qui tourne.",
  },
  {
    id: "deals",
    icon: "🤝",
    ...
    description:
      "Filtrage entrant, négociation, closing, suivi. Chaque deal est aligné avec ton positionnement et protégé contractuellement.",
  },
  {
    id: "legal-ops",
    icon: "📋",
    ...
    description:
      "Facturation, relances, contrats, pricing. Tout ce qui se passe en coulisses, géré pour toi.",
  },
  {
    id: "kpis",
    icon: "📊",
    title: "Pilotage & KPIs",
    description:
      "5 indicateurs max, revue hebdo, décisions claires. Pas de vanity metrics — des signaux actionnables.",
  },
  {
    id: "autonomy",
    icon: "🏗️",
    ...
    description:
      "Recrutement, process, formation. L'objectif : que tu n'aies plus besoin de nous.",
  },
];
