  ...
  items: [
    {
      ...
      microDescription:
        "On clarifie ce que tu représentes et ce que tu refuses. Une image lisible, cohérente, qui attire les bons deals.",
      detail: {
        intro:
          "Une identité claire fait gagner du temps partout : contenu, collaborations, décisions. C'est la base.",
        whatWeDo: [
        ...
        forWho:
          "Pour les talents qui veulent être lisibles et crédibles, sans se dénaturer.",
      },
    },
    {
      id: "series",
      ...
      microDescription:
        "On transforme ton talent en formats répétés. Plus de régularité, moins de stress 'quoi poster ?'.",
      detail: {
        intro:
          "Les séries construisent la fidélité. Les formats rendent la production simple et stable.",
        whatWeDo: [
        ...
        forWho:
          "Pour ceux qui veulent une machine à idées claire, sans s'éparpiller.",
      },
    },
    {
      id: "workflow",
      ...
      microDescription:
        "On met un pipeline pro : idée → script → tournage → montage → QA → publication. Tu tiens la cadence sans te cramer.",
      detail: {
        intro:
          "Le talent crée. Le workflow protège : qualité stable, délais tenus, moins de charge mentale.",
        whatWeDo: [
        ...
        forWho:
          "Pour les talents qui veulent de la constance sans sacrifier leur énergie.",
      },
    },
    {
      id: "kpis",
      ...
      microDescription:
        "On pilote avec 5 KPIs max. Chaque semaine : Stop / Scale / Test. Les chiffres deviennent un outil, pas un jugement.",
      detail: {
        intro:
          "Sans pilotage, tu répètes au hasard. Avec pilotage, tu construis une trajectoire.",
        whatWeDo: [
        ...
        forWho:
          "Pour ceux qui veulent comprendre ce qui marche, sans se prendre la tête.",
      },
    },
    {
      id: "pricing",
      ...
      microDescription:
        "On structure ton business : 3 offres claires, un prix plancher, des options propres. Tu n'improvises plus.",
      detail: {
        intro:
          "Une offre nette = moins de négos inutiles, plus de deals alignés.",
        whatWeDo: [
        ...
        forWho:
          "Pour les talents qui veulent être payés proprement, sans se brader.",
      },
    },
    {
      id: "deals",
      ...
      microDescription:
        "On filtre, on négocie, on suit. Tu prends les décisions — on gère la machine commerciale.",
      detail: {
        intro:
          "Le but n'est pas d'avoir plus de demandes. Le but est d'avoir de meilleures demandes.",
        whatWeDo: [
    ...
    },
    {
      ...
      microDescription:
        "On met l'administratif au carré : factures, relances, documents, organisation. Zéro chaos, zéro oublis.",
      detail: {
        intro:
          "L'admin n'est pas glamour, mais c'est ce qui sécurise une carrière.",
        whatWeDo: [
        ...
        forWho:
          "Pour ceux qui veulent être crédibles et carrés avec les marques.",
      },
    },
    {
      id: "events",
      ...
      microDescription:
        "On produit et on opère tes activations : logistique, coordination, captation, et contenu final. À petite comme à grande échelle.",
      detail: {
        intro:
          "Un event bien géré peut devenir : contenu, image, réseau, revenus. Mal géré, ça abîme tout.",
        whatWeDo: [
        ...
        forWho:
          "Pour les talents qui veulent des activations propres et exploitables.",
      },
    },
    {
      id: "formation",
      ...
      microDescription:
        "Tu comprends ce qu'on fait et pourquoi. L'objectif : autonomie — pas dépendance.",
      detail: {
        ...
        forWho:
          "Pour les talents qui veulent comprendre et maîtriser leur carrière.",
      },
    },
  ],
} as const;
