...
export const TRACKING_FEATURES: TrackingFeature[] = [
  {
    ...
    badge: "Temps réel",
    elsewhere: ["Reporting mensuel manuel", "Pas de benchmark"],
    wafia: [
  ...
  },
  {
    ...
    badge: "IA-powered",
    elsewhere: ["Comptage likes/vues", "Analyse post-campagne"],
    wafia: [
  ...
  },
  {
    ...
    elsewhere: ["PDF statique mensuel", "Vanity metrics uniquement"],
    wafia: [
