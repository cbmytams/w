...
export const STUDIO_PRODUCTIONS: StudioProduction[] = [
  {
    ...
    description:
      "Contenus courts, dynamiques et optimisés pour la conversion TikTok/Reels.",
    longDescription:
  ...
  },
  {
    ...
    longDescription:
      "AURA capture l'instant. De la Fashion Week aux lancements de produits exclusifs, nos équipes mobiles sont partout. Nous transformons vos événements physiques en résonance numérique mondiale grâce à des livestreams interactifs et des aftermovies instantanés.",
    icon: Clapperboard,
    color: "bg-purple-500",
