...
export const TEAM: TeamMember[] = [
  {
    ...
    role: "Brand strategist & creative producer",
    location: "Paris, France",
    slug: "sasha-guettat",
    shortBio:
      "Je ne suis pas un agent. Je construis des écosystèmes autour des talents et des marques.",
    proof: [
      "8 ans d’expérience",
      "350+ collaborations marques",
      "~400 talents activés",
    ],
  ...
  },
  {
    id: "yaelle",
    name: "Yaëlle",
    role: "Direction artistique & stratégie talents (Canada)",
    location: "Canada",
    slug: "yaelle",
