        ...
        <div className="w-full h-full bg-gray-50/50 rounded-2xl p-3 overflow-hidden relative font-sans">
            ...
            <div className="relative z-10 flex gap-3 h-full">
                ...
                <div className="flex-1 flex flex-col gap-3 min-w-0">
                    {/* Header (Desktop/Tablet mainly, adjusted for mobile) */}
                    <motion.div
                    ...
                    {/* Grid Content */}
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3 min-h-0 overflow-y-auto sm:overflow-visible pr-1 sm:pr-0">
                        {/* Left Column */}
