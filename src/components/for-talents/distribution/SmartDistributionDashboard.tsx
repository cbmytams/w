...
export function SmartDistributionDashboard() {
    ...
    return (
        <div className="w-full relative overflow-hidden rounded-2xl border border-black/5 dark:border-white/10 bg-white/70 dark:bg-[#0b111a]/70 backdrop-blur-3xl shadow-2xl">
