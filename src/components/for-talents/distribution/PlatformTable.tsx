...
export function PlatformTable({ platforms, categoryId = "distribution", subCategoryId }: PlatformTableProps) {
    ...
    const actionClasses = cn(
        ...
        showDesktopCols ? "px-5 py-2.5 text-[11px]" : "px-4 py-2 text-[12px]",
        accent.cta
    );
    const nameCol = cn(
        "col-span-12",
    ...
    return (
        <div ref={containerRef} className="flex-1 overflow-y-auto custom-scrollbar pb-8 relative">
            ...
            <div className="grid grid-cols-12 gap-5 px-8 py-4 border-b border-gray-100/50 dark:border-white/10 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl sticky top-0 z-10">
                <div className={cn("col-span-12 text-[12px] lg:text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]", nameCol)}>
                    Plateforme
                </div>
                {showDesktopCols && (
                    <>
                                        ...
                                        {!showDesktopCols && (
                                            <div className="mt-3 flex flex-wrap items-center gap-3">
                                                <div className="flex flex-wrap items-center gap-2">
                                                    <span
                                                        className={cn(
                                                            "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[12px] lg:text-[10px] font-bold uppercase tracking-wider border",
                                                            badge.className
                                                        )}
                                                    >
                                                        {badge.icon}
                                                    ...
                                                    <span
                                                        className={cn(
                                                            "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[12px] lg:text-[10px] font-bold border",
                                                            platform.isLive
                                                                ? "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-300 dark:border-emerald-500/30"
                                                                : "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/10 dark:text-amber-300 dark:border-amber-500/30"
                                                        )}
                                                    ...
                                                    {showSpeed && speedValue && (
                                                        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[12px] lg:text-[10px] font-bold border bg-slate-50 text-slate-700 border-slate-200 dark:bg-white/10 dark:text-white/70 dark:border-white/15">
                                ...
                                {showDesktopCols && (
                                    <>
                                        ...
                                        <div className="hidden lg:flex lg:col-span-2 items-center">
                                            <span
                                                className={cn(
                                                    "inline-flex items-center gap-2 px-3 py-1.5 rounded-xl text-[12px] lg:text-[11px] font-bold border",
                                                    platform.isLive
                                                        ? "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-300 dark:border-emerald-500/30"
                                                        : "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/10 dark:text-amber-300 dark:border-amber-500/30"
                                                )}
                            ...
                            <div className="relative h-full flex flex-col p-5 sm:p-6">
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setSelectedId(null)}
                                        className="w-11 h-11 rounded-2xl border border-gray-200/70 dark:border-white/10 text-gray-500 dark:text-white/70 hover:text-gray-900 dark:hover:text-white hover:bg-white/80 dark:hover:bg-white/10 transition"
                                        aria-label="Fermer"
                                    >
                                ...
                                <div className="mt-6">
                                    <h4 className="text-[12px] lg:text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">
                                        Description
                                    </h4>
                                ...
                                {selectedPlatform.metrics && (
                                    <div className="mt-6 grid grid-cols-2 gap-3">
                                        {[
                                            ...
                                            >
                                                <div className="text-[12px] lg:text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                                    {item.label}
                                                </div>
