            ...
            <Container>
                <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                    <RevealAnimation>
                        ...
                        <p className="text-lg text-slate-600 dark:text-white/70 whitespace-pre-line mb-8">
                        ...
                        <div className="flex flex-wrap gap-3">
                            {TALENT_PROOF_STRIP.badges.map((badge) => (
                                <span
                                    key={badge}
                                    className="px-4 py-2 rounded-full text-xs font-semibold uppercase tracking-wider bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white/80"
                                >
                                    {badge}
                                </span>
                            ))}
                    ...
                    <RevealAnimation delay={0.15}>
                        <div className="rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl p-8 shadow-[0_24px_60px_rgba(0,0,0,0.12)] dark:shadow-[0_24px_60px_rgba(0,0,0,0.35)]">
                            ...
                            <ul className="space-y-4">
                                {TALENT_PROOF_STRIP.bullets.map((item) => (
                                    <li key={item} className="flex items-start gap-3 text-slate-700 dark:text-white/80">
