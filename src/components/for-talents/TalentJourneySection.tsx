                                ...
                                return (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            isActive ? "text-slate-900 dark:text-white" : "text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300"
                                        )}
                                    >
                        ...
                        <div className="relative min-h-[220px] sm:min-h-[160px] flex items-center justify-center">
                            <AnimatePresence mode="wait" custom={direction}>
                                <motion.div
                                    key={activeIndex}
                                    custom={direction}
                                    initial={{ opacity: 0, filter: prefersReducedMotion ? "blur(0px)" : "blur(8px)", y: prefersReducedMotion ? 0 : 10 }}
                                    animate={{ opacity: 1, filter: "blur(0px)", y: 0 }}
                                    exit={{ opacity: 0, filter: prefersReducedMotion ? "blur(0px)" : "blur(8px)", y: prefersReducedMotion ? 0 : -10 }}
