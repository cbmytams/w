        ...
        <div className={cn("py-8 md:py-12", className)}>
            <Container>
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/70 dark:bg-white/[0.08] border border-slate-200/70 dark:border-white/10 backdrop-blur-xl shadow-md shadow-black/5 dark:shadow-black/20">
