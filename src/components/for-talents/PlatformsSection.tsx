                        ...
                        {TALENT_PLATFORMS.cards.map((card, i) => {
                            ...
                            return (
                                <RevealAnimation key={i} delay={i * 0.1}>
                                    <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-3xl p-10 h-full transition-all duration-300 border border-slate-200 dark:border-white/10 group hover:border-pink-500/40 hover:shadow-[0_24px_60px_rgba(236,72,153,0.2)]">
