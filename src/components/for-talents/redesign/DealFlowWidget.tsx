    ...
    return (
        <div className="relative w-full max-w-md mx-auto aspect-[4/5] flex flex-col justify-center">
            ...
            <div className="relative z-10 space-y-4">
                ...
                >
                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h4 className="font-bold text-slate-900 leading-tight">Brand X</h4>
                                <span className="text-xs font-medium text-slate-500">Campagne Q1</span>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-end">
                            <div>
                                <div className="text-xs text-slate-400 font-medium mb-1">Montant sécurisé</div>
                                <div className="text-2xl font-bold text-slate-900 tracking-tight">8 500 €</div>
                            </div>
                ...
                >
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h4 className="font-bold text-slate-900 leading-tight">Agency Pro</h4>
                                <span className="text-xs font-medium text-slate-500">Négociation</span>
                            </div>
                        </div>
                    ...
                    <div className="flex justify-between items-center bg-slate-50 rounded-xl p-3 border border-slate-100">
                        <div className="text-sm font-medium text-slate-500">Offre initiale</div>
                        <div className="text-sm font-bold text-slate-400 line-through">10 000 €</div>
                    </div>
                ...
                <motion.div
                    className="absolute -bottom-6 -right-4 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3 z-20"
