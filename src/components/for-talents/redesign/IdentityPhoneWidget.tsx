        ...
        <div className="relative w-full flex items-center justify-center py-2">
            ...
            <div className="relative w-full max-w-[280px] sm:max-w-[300px] aspect-[9/19]">
                ...
                <div className="relative z-10 h-full p-4 pt-7 flex flex-col gap-3">
                    <div className="flex items-center justify-between text-[10px] font-semibold tracking-widest uppercase text-slate-400 dark:text-white/50">
                    ...
                    <div className="rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-200/60 dark:border-white/10 p-3 shadow-sm">
                        ...
                        <div className="mt-2 flex items-center gap-2">
                            {PRIMARY_PLATFORMS.map((platform) => (
                                <div
                                    key={platform.name}
                                    className="w-9 h-9 rounded-xl bg-white dark:bg-white/10 border border-slate-200/70 dark:border-white/10 flex items-center justify-center shadow-sm"
                                >
                                    <Image
                                        src={platform.src}
                                        alt={platform.name}
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div className="rounded-2xl bg-white dark:bg-white/5 border border-slate-200/70 dark:border-white/10 p-3 shadow-sm">
                            <div className="text-[10px] uppercase tracking-widest text-slate-400 dark:text-white/50">
                                Positionnement
                            </div>
                    ...
                    <div className="rounded-2xl bg-slate-900 text-white p-3 shadow-lg">
