...
export function BusinessSection() {
    return (
        <section id="business" className="py-32 px-4 bg-white">
            <Container>
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <RevealAnimation>
                        ...
                        <div className="space-y-6 mb-10">
                            ...
                            <div className="pl-6 border-l-4 border-pink-200">
                        ...
                        <div className="space-y-4">
                            {TALENT_BUSINESS.steps.map((item, i) => (
                                <div
                                    key={i}
                                    className="flex items-center p-5 rounded-2xl bg-gray-50 border border-gray-100 hover:border-pink-200 transition-colors"
                                >
                    ...
                    <RevealAnimation delay={0.2}>
                        <div className="relative bg-gray-50 rounded-3xl p-8 md:p-12 border border-gray-100 flex flex-col items-center justify-center overflow-hidden min-h-[500px]">
                            <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:20px_20px] opacity-70" />
