            ...
            <Container>
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <RevealAnimation>
                        ...
                        <div className="space-y-4">
                            {TALENT_BUSINESS.steps.map((item, i) => (
                                <div
                                    key={i}
                                    className="flex items-center p-5 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-pink-500/30 transition-colors"
                                >
                    ...
                    <RevealAnimation delay={0.2}>
                        <div className="relative bg-slate-50 dark:bg-white/5 backdrop-blur-xl rounded-2xl p-8 md:p-12 border border-slate-200 dark:border-white/10 flex flex-col items-center justify-center overflow-hidden min-h-[500px] shadow-2xl dark:shadow-2xl">
