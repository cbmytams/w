...
export function TalentJourneySection() {
    ...
    // Group steps by phase for rendering separators

    return (
        <section
            ref={containerRef}
            id={TALENT_JOURNEY_HEADER.id}
        ...
        >
            <Container>
                <div className="max-w-5xl mx-auto relative">
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-16 pb-20">
                            {TALENT_JOURNEY_STEPS.map((step, i) => {
                                ...
                                const Widget = step.widget ? widgetMap[step.widget] : null
                                    ...
                                    <div key={step.id}>
                                        ...
                                        <div className={cn(
                                            ...
                                            <div className={cn(
                                                ...
                                                `group-hover:${phaseConfig?.borderColor}`,
                                                ...
                                                <div className={cn(
                                                    ...
                                                    "transition-colors duration-500",
                                                    `group-hover:bg-gradient-to-br group-hover:${getPhaseGradient(step.phase)}`
                                                )} />
                                            </div>
                                            ...
                                            <motion.div
                                                ...
                                                className={cn(
                                                    ...
                                                    "border border-gray-200/50 dark:border-zinc-800",
                                                    "hover:border-violet-500/25 hover:bg-white/80 dark:hover:bg-zinc-900/80",
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-4 mb-4">
                                                    ...
                                                    <div className="h-px flex-1 bg-gray-100 dark:bg-zinc-800 group-hover:bg-violet-500/20 transition-colors" />
                                                </div>
                        ...
                        {/* Terminal Node (The Goal - Independence) */}
                        <div className="absolute left-[20px] md:left-1/2 bottom-0 -translate-x-1/2 translate-y-1/2 z-20">
                            <motion.div
                                ...
                                className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-500/30 border-4 border-white dark:border-zinc-950 relative"
                            >
                    ...
                    {/* Signature (The Motto - Detached from timeline) */}
                    <div className="mt-24 mb-8 md:mb-10 text-center">
                        {disableJourneyMotion ? (
                            <h3 className="text-3xl md:text-5xl font-bold tracking-tight inline-block max-w-4xl mx-auto leading-tight bg-gradient-to-br from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
                            ...
                            >
                                {TALENT_JOURNEY_HEADER.signature.split(" ").map((word, i) => (
                                    <motion.span
                                        ...
                                        className="inline-block mr-[0.25em] bg-gradient-to-br from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent"
                                    >
                                        {word}
                                    </motion.span>
                                ))}
