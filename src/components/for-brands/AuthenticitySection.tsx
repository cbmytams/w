...
export function AuthenticitySection() {
    return (
        <section className="relative py-20 md:py-28 px-4 bg-transparent z-20">
            ...
            <Container className="relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                    ...
                    <div className="relative mx-auto w-full max-w-[560px]">
                        ...
                        <div className="absolute inset-0 -z-10 rounded-2xl bg-white border border-slate-200 shadow-2xl dark:bg-white/5 dark:border-white/10 dark:shadow-2xl" />
                        <StaggerContainer className="space-y-5 p-6 lg:p-8">
                            {AUTHENTICITY_CARDS.map((card) => (
                                <FadeIn key={card.id} delay={card.delay}>
                                    <div className="group relative overflow-hidden rounded-2xl border border-slate-200/70 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-slate-300/80 hover:shadow-2xl dark:border-white/10 dark:bg-white/5 dark:hover:border-white/20 dark:hover:bg-white/10">
