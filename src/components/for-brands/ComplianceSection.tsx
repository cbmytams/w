            ...
            <div className="bg-white dark:bg-zinc-900/70 rounded-2xl p-12 shadow-xl border-2 border-slate-200 dark:border-zinc-800">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-10">
                {[
                  ...
                  <div
                    key={i}
                    className="px-6 py-3 bg-slate-50 dark:bg-zinc-800/60 rounded-full border-2 border-slate-200 dark:border-zinc-700 flex items-center gap-2"
                  >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  {
                    title: "Respect ARPP",
                    desc: "Influence responsable, mentions légales, transparence",
                  },
                  {
                    title: "Traçabilité RGPD/DSA",
                    desc: "Mentions, durées, territoires, droits d'utilisation",
                  },
                  {
