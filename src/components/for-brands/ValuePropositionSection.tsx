...
function PillarCard({
  ...
  pillar: (typeof VALUE_PILLARS)[number];
  index: number;
}) {
          ...
          transition={
            disableMotion
              ...
              : {
                  ...
                  delay: clampDelay(0.18 + index * 0.08),
                }
          }
        />
                ...
                transition={
                  disableMotion
                    ...
                    : {
                        ...
                        delay: clampDelay(0.18 + index * 0.1 + j * 0.05),
                      }
                }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.p
              ...
              viewport={disableMotion ? undefined : viewport}
              transition={
                disableMotion ? undefined : { duration: transitionDuration }
              }
            ...
            <motion.p
              ...
              transition={
                disableMotion
                  ? undefined
                  : { duration: transitionDuration, delay: clampDelay(0.18) }
              }
