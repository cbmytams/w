...
const STATS = [
    { label: "Vues TikTok (Mois dernier)", value: "3.7M", suffix: "+", network: "TikTok", color: "text-cyan-400" },
    { label: "Abonnés TikTok", value: "320K", suffix: "", network: "TikTok", color: "text-cyan-400" },
    { label: "Vues YouTube (Année)", value: "15M", suffix: "+", network: "YouTube", color: "text-red-500" },
    { label: "Comptes Touchés Insta (90j)", value: "2.1M", suffix: "", network: "Instagram", color: "text-pink-500" },
]
                        ...
                        <FadeIn key={stat.label} delay={index * 0.1}>
                            ...
                            >
                                ...
                                <div className="mt-8 flex items-baseline gap-1">
                                    <span className={`text-5xl md:text-6xl font-black tracking-tighter ${stat.color}`}>
                                        {stat.value}
                                    </span>
