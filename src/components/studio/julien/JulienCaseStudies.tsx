                ...
                <FadeIn>
                    <div className="mb-20 text-center">
                        ...
                        <p className="text-zinc-500 font-medium mt-6 max-w-2xl mx-auto uppercase tracking-widest text-sm">
                            Behind the scenes & masterclass executions pour les plus grandes marques mondiales.
                        </p>
                    </div>
                </FadeIn>
                            ...
                            <div className={`flex flex-col ${index % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8 md:gap-16 items-center`}>
                                ...
                                <div className="w-full md:w-1/2 flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-wrap gap-3 mt-4">
                                        {study.tags.map((tag) => (
                                            <span key={tag} className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-xs font-bold text-white/70 uppercase tracking-wider">
                                                {tag}
                                            </span>
                                        ))}
                                    </div>
