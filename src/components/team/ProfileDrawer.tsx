...
const DRAWER_CONTENT: Record<string, DrawerContentEntry> = {
  sasha: {
    manifesto:
      "Je ne crois pas au 'talent management'. Je crois à l'architecture de carrière. Un agent attend que le téléphone sonne. Un architecte dessine les plans, pose les fondations et construit l'édifice.",
    expertise: [
      {
        icon: Briefcase,
        title: "Brand Strategy",
        desc: "Positionnement & Identité",
      },
      {
        icon: Award,
        title: "Talent Development",
        desc: "Coaching & Trajectoire",
      },
      { icon: Calendar, title: "Campaign Ops", desc: "360° Operations" },
      {
        icon: ExternalLink,
        title: "Network Growth",
        desc: "Partenariats Stratégiques",
      },
    ],
  },
  yaelle: {
    manifesto:
      "L'image n'est rien sans le fond. Mon rôle est d'aligner la vérité du talent avec sa projection publique. Nous ne fabriquons pas des personnages, nous révélons des personnalités.",
    expertise: [
      {
        icon: Briefcase,
        title: "Direction Artistique",
        desc: "Identité visuelle & Ton",
      },
          ...
          >
            ...
            <div className="w-full h-full flex items-center justify-center p-4">
              ...
              >
                ...
                <div
                  className="absolute inset-0 opacity-[0.03] z-[5] pointer-events-none"
                  style={{
                ...
                <div className="relative h-[260px] w-full overflow-hidden shrink-0">
                  ...
                  <motion.div
                    className={cn(
                      "absolute inset-0 opacity-30 dark:opacity-40 bg-gradient-to-br bg-[length:400%_400%]",
                      gradientClass
                    )}
                    animate={
                      shouldReduceMotion
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-7 pb-6 z-10 bg-gradient-to-t from-white via-white/20 to-transparent dark:from-[#0b111a] dark:via-[#0b111a]/20">
                    ...
                    >
                      ...
                      <h2
                        ...
                        className="text-4xl font-black text-slate-900 dark:text-white leading-[0.9] mb-1 tracking-tight"
                      >
                        {member.name.split(" ")[0]}
                        <span className="opacity-40 font-medium ml-2 text-2xl tracking-normal">
                      ...
                      {activeTab === "manifesto" && (
                        <div className="space-y-6 pb-4">
                            ...
                            {member.links?.linkedin && (
                              ...
                              >
                                <Link
                                  ...
                                  className="p-3 rounded-2xl bg-slate-50 dark:bg-white/5 text-slate-400 hover:text-[#0077b5] hover:bg-[#0077b5]/10 transition-colors block border border-transparent hover:border-[#0077b5]/20"
                                >
                            ...
                            {member.links?.instagram && (
                              ...
                              >
                                <Link
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="p-3 rounded-2xl bg-slate-50 dark:bg-white/5 text-slate-400 hover:text-[#E4405F] hover:bg-[#E4405F]/10 transition-colors block border border-transparent hover:border-[#E4405F]/20"
                                >
                            ...
                            {member.links?.email && (
                              ...
                              >
                                <Link
                                  ...
                                  className="p-3 rounded-2xl bg-slate-50 dark:bg-white/5 text-slate-400 hover:text-orange-500 hover:bg-orange-500/10 transition-colors block border border-transparent hover:border-orange-500/20"
                                >
                          ...
                          <div className="relative pt-2">
                            <Quote
                              className="absolute -top-4 -left-3 w-10 h-10 opacity-5 dark:opacity-[0.03] text-current block"
                              style={{ color: primaryColor }}
                            />
                            ...
                            {member.proof.slice(0, 3).map((proof, i) => {
                              ...
                              return (
                                <div
                                  key={i}
                                  className={cn(
                                    "p-4 rounded-xl border border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/5 flex items-center gap-4",
                                    bgSoftClass
                                  )}
                                >
                                  <span
                                    className="text-2xl font-bold tracking-tight min-w-[60px] text-right"
                                    style={{ color: primaryColor }}
                                  >
                                    {number}
                                  </span>
                        ...
                        <div className="grid grid-cols-2 gap-3 pb-4 perspective-[1000px]">
                          {extendedData.expertise.map((item, i: number) => (
                            ...
                            >
                              <div
                                className={cn(
                                  "w-12 h-12 rounded-2xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110 group-hover:rotate-[-5deg]",
                                  bgSoftClass
                                )}
                              >
                                <item.icon
