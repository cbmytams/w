...
export default function WikiCategoryView({ type, title, articles, allArticles }: WikiCategoryViewProps) {
    ...
    return (
        <div id="wiki-root" className="min-h-screen font-sans flex flex-col" style={{ color: 'var(--wiki-ink)' }}>
            ...
            <main id="main-content" className="pt-32 px-6 md:px-12 max-w-4xl mx-auto pb-24 flex-1 w-full relative z-10">
                ...
                >
                    <p className="font-mono text-xs uppercase tracking-[0.3em] mb-4" style={{ color: 'var(--wiki-ink-secondary)' }}>
                ...
                <div className="flex flex-col">
                    {articles.length === 0 ? (
                        ...
                        >
                            <p className="font-mono text-sm mb-2" style={{ color: 'var(--wiki-ink-secondary)' }}>Aucun article trouvé.</p>
                            <p className="font-serif text-lg italic" style={{ color: 'var(--wiki-ink-muted)' }}>Ce contenu est en cours de rédaction.</p>
                        </motion.div>
                    ) : (
            ...
            <footer className="border-t py-12 px-6 md:px-12 max-w-4xl mx-auto w-full relative z-10" style={{ borderColor: 'var(--wiki-line)' }}>
