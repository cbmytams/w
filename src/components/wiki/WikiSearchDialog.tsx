  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        style={{
          backgroundColor: "var(--wiki-search-bg)",
      ...
      >
        <motion.div
          ...
          style={{
            backgroundColor: "var(--wiki-bg-elevated)",
            borderColor: "var(--wiki-line)",
          }}
        >
          <div
            className="flex items-center px-6 py-2 border-b gap-2"
          ...
          <div className="max-h-[50vh] overflow-y-auto w-full">
            {results.length > 0 ? (
              <div className="py-2">
                {results.map((r) => (
                  ...
                  >
                    ...
                    <span style={{ color: "var(--wiki-ink-secondary)" }}>
                      →
                    </span>
                  </Link>
                ))}
              ...
              <div
                className="py-16 text-center font-mono text-sm max-w-md mx-auto"
                style={{ color: "var(--wiki-ink-secondary)" }}
              >
              ...
              <div
                className="py-10 text-center font-mono text-sm uppercase tracking-widest border-t"
                style={{
