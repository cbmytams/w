...
export function BackgroundFlow({ variant = "brands" }: { variant?: BackgroundFlowVariant }) {
    ...
    // overlays (drawers/modals). Keep constrained runtimes lightweight:
    // mobile devices, save-data connections, and low-memory devices.
    const isConstrainedRuntime = isMobile || saveData || lowMemory
    const allowAmbientAnimation = !prefersReducedMotion && !isBrandsVariant && !isConstrainedRuntime
    const allowGlowPulse = !prefersReducedMotion && !isConstrainedRuntime
    const allowParallax = !prefersReducedMotion && !isConstrainedRuntime
    ...
    const glowLayerClasses = isConstrainedRuntime
        ...
        <div className="pointer-events-none fixed inset-0 z-0">
            ...
            >
                <div
                    ...
                    style={{
                        background: isConstrainedRuntime
                            ? palette.glowA.soft
