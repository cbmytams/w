...
export const routeTransitionTiming: Record<
  RouteCluster,
  Record<RouteDeviceProfile, Transition>
> = {
  home: {
...
export const routeVeilClassNames: Record<RouteCluster, string> = {
  home: "bg-transparent",
  talents:
    "bg-gradient-to-br from-violet-400/10 via-transparent to-transparent dark:from-violet-400/12",
  brands:
