...
export const metadata: Metadata = {
  ...
  description:
    "Informations sur la collecte, l'utilisation et les droits liés aux données personnelles.",
  alternates: {
    ...
    <LegalContainer>
      ...
      <LegalSection title="1. Collecte des données">
        <p>
          ...
          déroulement de nos échanges et de nos collaborations. Ces données sont
          recueillies lorsque vous utilisez nos formulaires de contact ou
        ...
        <div className="mt-6 grid gap-4">
          {[
            ...
            >
              ...
              <span className="relative z-10 text-sm md:text-base font-medium text-slate-700 dark:text-slate-200">
                {item}
              </span>
            </div>
          ))}
      ...
      <LegalSection title="2. Utilisation des données">
        <p>
          Vos données ne sont jamais revendues. Elles sont utilisées
          exclusivement pour :
        </p>
          ...
          <div className="relative z-10">
            ...
            <p className="font-medium text-slate-900 dark:text-white">
              ...
              <a
                ...
                className="inline-block mt-3 px-6 py-3 bg-white/50 dark:bg-white/10 hover:bg-white dark:hover:bg-white/20 border border-black/5 dark:border-white/10 rounded-full text-violet-600 dark:text-violet-400 font-semibold tracking-tight transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
              >
                contact@wafia.fr
              </a>
            </p>
