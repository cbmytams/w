  ...
  return (
    <LegalContainer>
      ...
      <LegalSection title="Éditeur du site">
        <p className="mb-6">
          Le site Wafia est édité par l&apos;agence Wafia, une structure dédiée
          à l&apos;accompagnement des talents et à la stratégie des marques.
        </p>
        <LegalGrid>
          <LegalCard
          ...
          />
          <LegalCard title="SIREN" value="929 439 735" />
          <LegalCard title="RCS Créteil" value="929 439 735" />
          <LegalCard title="Capital Social" value="1 000,00 €" />
          <LegalCard title="Date de création" value="30 mai 2024" />
          <LegalCard
            title="Siège Social"
      ...
      <LegalSection title="Hébergement">
        <p>
          L&apos;infrastructure technique du site est assurée par OVH, leader
          européen de l&apos;hébergement cloud, garantissant performance et
          sécurité.
        </p>
        <div className="mt-6">
          <LegalGrid>
            ...
            <LegalCard
              ...
              icon={<Globe className="w-4 h-4 text-slate-400" />}
            />
            <LegalCard title="RCS" value="Lille Métropole 424 761 419 00045" />
            <LegalCard title="N° TVA" value="FR 22 424 761 419" />
          </LegalGrid>
        </div>
      </LegalSection>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start gap-6 md:gap-8">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-white/70 text-base md:text-lg leading-relaxed font-medium">
                ...
                animations, logo) relève de la législation française et
                internationale sur le droit d&apos;auteur et la propriété
                intellectuelle. Toute reproduction, modification ou utilisation
                non autorisée est strictement interdite sans l&apos;accord écrit
                de Wafia Agency.
              </p>
            </div>
          </div>
