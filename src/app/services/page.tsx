...
const SERVICES = [
    {
        ...
        deliverables: ["Brief créatif", "Shortlist casting", "Dashboard live", "Bilan de campagne"],
    ...
    },
    {
        ...
        deliverables: ["Rushes bruts", "Montages finaux", "Packs ads multi-formats", "Adaptations plateforme"],
    ...
    },
    {
        ...
        deliverables: ["Roadmap carrière", "Contrats sécurisés", "Ligne éditoriale", "Bilan trimestriel"],
    ...
    },
    {
        ...
        deliverables: ["Dashboard accès client", "Reporting KPI unifié", "Suivi budgétaire", "Facturation transparente"],
        cta: null,
    },
]
...
const influenceServiceJsonLd = serviceSchema({
    ...
    description: "Conception et pilotage de campagnes d'influence marketing : casting data-driven, activation multi-plateforme et reporting KPI.",
...
const studioServiceJsonLd = serviceSchema({
    ...
    description: "Production de contenu social-first : UGC authentique, montage dynamique, VFX et déclinaisons multi-formats.",
...
const talentServiceJsonLd = serviceSchema({
    ...
    description: "Management de créateurs : positionnement éditorial, négociation contrats, roadmap carrière et monétisation durable.",
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                        {STATS.map((stat, i) => (
                            <div key={i} className="text-center">
                                <div className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-2">{stat.value}</div>
                ...
                <Container>
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg text-slate-400 mb-10">
                            Discutons de vos objectifs et construisons un dispositif sur mesure.
                        </p>
