    ...
    return (
        <div className="space-y-6">
            <div className="surface-card p-6">
                <div className="text-[10px] uppercase tracking-[0.35em] text-white/25 font-medium mb-1">Monitor</div>
                <h1 className="text-lg font-semibold text-white/90">Intégrité Talents</h1>
