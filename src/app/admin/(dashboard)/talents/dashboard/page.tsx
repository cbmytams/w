...
const KPI_META = [
  { icon: Users, color: "from-blue-500 to-indigo-500", shadow: "shadow-blue-500/20" },
  { icon: TrendingUp, color: "from-emerald-400 to-teal-500", shadow: "shadow-emerald-500/20" },
  { icon: FileCheck, color: "from-orange-400 to-amber-500", shadow: "shadow-orange-500/20" },
  { icon: Clock, color: "from-pink-500 to-rose-500", shadow: "shadow-pink-500/20" },
];

export default async function TalentsDashboardPage(
