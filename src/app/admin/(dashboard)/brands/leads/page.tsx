...
export const metadata: Metadata = {
  ...
  description: "Base de données marques centralisée.",
};
...
export default async function BrandsLeadsPage(
    ...
    <div className="space-y-6">
      ...
      <div className="surface-card p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <div className="text-lg font-semibold text-white/90 mt-0.5">Marques</div>
      ...
      <div className="surface-card overflow-hidden">
        {leads.length === 0 ? (
          <div className="py-24 flex flex-col items-center text-center gap-4">
            ...
            <div>
              <h3 className="text-base font-semibold text-white/70">Aucune marque enregistrée</h3>
              <p className="text-sm text-white/30 mt-1 max-w-xs">Les leads apparaîtront ici dès qu'une marque soumet le questionnaire.</p>
            </div>
            <a
              href="/questionnaire/brands"
              target="_blank"
                ...
                return (
                  <div key={lead.id} className="grid grid-cols-[2fr_2fr_1fr_1fr_auto] gap-4 px-6 py-4 items-center text-sm hover:bg-white/[0.02] transition">
                    ...
                    <div className="text-right">
                      {lead.responseId ? (
                        <Link
                          href={`/admin/brands/leads/${lead.id}`}
