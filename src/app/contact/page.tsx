                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="brand-name" name="brand-name" placeholder="Jean Dupont" />
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="brand-email" className="text-sm font-medium">Email professionnel</label>
                                    <Input id="brand-email" name="brand-email" type="email" placeholder="jean@entreprise.com" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label htmlFor="brand-company" className="text-sm font-medium">Société</label>
                                <Input id="brand-company" name="brand-company" placeholder="Nom de votre entreprise" />
                            </div>
                            <div className="space-y-2">
                                <label htmlFor="brand-budget" className="text-sm font-medium">Budget estimé</label>
                                <select id="brand-budget" name="brand-budget" className="flex h-11 w-full rounded-md border border-slate-200 bg-transparent px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950">
                            ...
                            <Button className="w-full" size="lg">Envoyer la demande</Button>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="talent-name" name="talent-name" placeholder="@pseudo" />
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="talent-city" className="text-sm font-medium">Ville</label>
                                    <Input id="talent-city" name="talent-city" placeholder="Paris" />
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <label htmlFor="talent-email" className="text-sm font-medium">Email</label>
                                    <Input id="talent-email" name="talent-email" type="email" placeholder="contact@talent.com" />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <select id="talent-monetize" name="talent-monetize" className="flex h-11 w-full rounded-md border border-slate-200 bg-transparent px-3 py-1 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-900">
                                        <option>Oui</option>
                                        <option>Non</option>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select id="talent-stats" name="talent-stats" className="flex h-11 w-full rounded-md border border-slate-200 bg-transparent px-3 py-1 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-900">
                            ...
                            <Button className="w-full" size="lg">Envoyer ma candidature</Button>
                        </CardContent>
                    </Card>
                )}
            </div>
