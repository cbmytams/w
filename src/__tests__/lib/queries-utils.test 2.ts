...
describe("dashboard queries utils", () => {
    describe("parseDate", () => {
        it("should parse a valid date string", () => {
            ...
            expect(parseDate("2024-05-15T00:00:00.000Z", fallback).getTime()).toBe(new Date("2024-05-15T00:00:00.000Z").getTime());
        });
    ...
    describe("previousRange", () => {
        it("should calculate correct previous window for a 10-day range", () => {
            ...
            expect(prev.previousStart.getTime()).toBe(prev.previousEnd.getTime() - (end.getTime() - start.getTime()));
        });
    });
