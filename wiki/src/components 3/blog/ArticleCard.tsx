            ...
            <div className="flex justify-between items-start gap-8">
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-4">
                        <span className="text-[10px] font-mono uppercase tracking-[0.2em]" style={{ color: 'var(--ink-secondary)' }}>
                            {article.category}
                        </span>
                        <span className="w-4 h-px" style={{ backgroundColor: 'var(--line)' }} />
                        <span className="text-[10px] font-mono uppercase tracking-[0.2em]" style={{ color: 'var(--ink-secondary)' }}>
                            {article.time}
                        </span>
                    </div>
                ...
                <div className="w-10 h-10 rounded-full border flex items-center justify-center group-hover:opacity-60 transition-all duration-300 shrink-0" style={{ borderColor: 'var(--line)' }}>
