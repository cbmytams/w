...
**Slug :** tarifs-influenceur-calcul-prix-cpm-cpe-usage-rights  
**Meta description :** Méthode complète pour fixer tes tarifs : CPM/CPE, valeur créative, complexité, exclusivité et droits d’usage (usage rights) + checklists et erreurs.  
**Catégorie :** Business & Contrats
...
1) **Distribution** (impressions / reach)  
2) **Influence** (confiance → conversion)  
3) **Création** (concept + tournage + montage)  
4) **Droits** (réutilisation, publicité, durée, territoire)
...
## Étape 1 — Calculer ta base (avec une fenêtre réaliste)
...
## Étape 2 — Choisir ton modèle de pricing (forfait, CPM, CPE)
...
## 3) Usage rights (droits d’usage) : l’endroit où tu perds le plus d’argent
...
## 4) Exclusivité : le coût d’opportunité
...
1) **Moins de livrables**  
2) **Moins de droits** (ex : pas d’ads)  
3) **Moins d’exclusivité**
...
1) Fixer un prix sur un post viral (au lieu d’une moyenne)  
2) Oublier les droits d’usage  
3) Accepter une exclusivité “large” sans compensation  
4) Ne pas limiter les révisions  
5) Ne pas préciser la durée de publication  
6) Ne pas cadrer les deadlines (validation, tournage, publication)  
7) Dire “ok” avant d’avoir le scope écrit
