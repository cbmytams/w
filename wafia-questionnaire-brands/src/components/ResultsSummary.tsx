...
export function ResultsSummary({ result, onReset }: ResultsSummaryProps) {
  ...
  const shouldAutoOpen =
    ...
    window.location.pathname === "/questionnaire/fiche";
        ...
        >
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <div className="relative inline-block select-none">
              ...
              <span
                className="absolute top-1 left-1 text-[clamp(5rem,15vw,10rem)] font-black leading-none tracking-tighter text-transparent"
              ...
              <div className="absolute top-0 -right-2 sm:-right-4 md:-right-8 flex flex-col items-center">
                <span className="text-2xl md:text-3xl font-bold text-zinc-500 line-through decoration-[var(--heat-accent)]/50 decoration-2">
                  100
                </span>
              </div>
            </div>
