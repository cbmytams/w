...
export function NavigationButtons({
    ...
    return (
        <div className="fixed left-1/2 -translate-x-1/2 z-40 w-[min(92vw,600px)]" style={{ bottom: 'calc(1.5rem + env(safe-area-inset-bottom, 0px))' }}>
            <motion.div
            ...
            >
                ...
                <motion.button
                    ...
                    whileHover={(canProceed && !isSubmitting) ? { scale: 1.02, boxShadow: "0 0 30px rgba(249, 115, 22, 0.4)" } : {}}
                    ...
                    style={{ background: 'linear-gradient(90deg, var(--heat-start), var(--heat-end))' }}
                >
                    <div className="absolute inset-0 bg-white/20 opacity-0 hover:opacity-100 transition-opacity" />

                    <span className="relative z-10 flex items-center justify-center gap-3">
                        {isSubmitting ? 'Chargement...' : isLastQuestion ? 'Voir mon profil' : 'Suivant'}
