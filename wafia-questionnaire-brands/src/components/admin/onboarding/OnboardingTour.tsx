...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    description:
      "Voici un tour rapide pour vous familiariser avec les fonctionnalités principales.",
    position: "center",
  },
  {
    ...
    description:
      "Suivez en temps réel vos indicateurs de performance : nombre de prospects, taux de conversion, scores moyens...",
    position: "bottom",
  },
  {
    ...
    description:
      'Gérez votre pipeline de vente en Kanban : déplacez les prospects de "Nouveau" à "Signé"',
    position: "right",
  },
  {
    ...
    description:
      "Modifiez les questions du diagnostic, ajustez les logiques conditionnelles, et personnalisez l'expérience",
    position: "right",
  },
  {
    ...
    title: "❓ Besoin d'Aide ?",
    description:
      "Activez le mode aide à tout moment pour voir des explications contextuelles sur chaque élément",
    position: "bottom",
  },
];
