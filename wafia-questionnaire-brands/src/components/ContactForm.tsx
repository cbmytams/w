                ...
                {!submitted ? (
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            {/* Name */}
                            <div>
                                <label htmlFor="contact-name" className="block text-xs uppercase tracking-widest text-zinc-500 font-medium mb-1.5">
                                    Nom & prénom <span className="text-[var(--heat-start)]">*</span>
                                </label>
                                <input
                                    id="contact-name"
                                    type="text"
                            ...
                            {/* Email */}
                            <div>
                                <label htmlFor="contact-email" className="block text-xs uppercase tracking-widest text-zinc-500 font-medium mb-1.5">
                                    Email professionnel <span className="text-[var(--heat-start)]">*</span>
                                </label>
                                <input
                                    id="contact-email"
                                    type="email"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="contact-phone" className="block text-xs uppercase tracking-widest text-zinc-500 font-medium mb-1.5">
                                        Téléphone
                                    </label>
                                    <input
                                        id="contact-phone"
                                ...
                                <div>
                                    <label htmlFor="contact-company" className="block text-xs uppercase tracking-widest text-zinc-500 font-medium mb-1.5">
                                        Entreprise <span className="text-[var(--heat-start)]">*</span>
                                    </label>
                                    <input
                                        id="contact-company"
                                        type="text"
                            ...
                            {/* Need Dropdown */}
                            <div>
                                <label htmlFor="contact-need" className="block text-xs uppercase tracking-widest text-zinc-500 font-medium mb-1.5">
                            ...
                            <motion.button
                                ...
                                className={`w-full flex items-center justify-center gap-2 py-4 rounded-xl font-bold text-base transition-all duration-300 mt-6 ${isValid
                        ...
                        <p className="text-[11px] text-zinc-600 text-center mt-4">
                            En soumettant ce formulaire, vous acceptez d&apos;être recontacté par Wafia.
                        </p>
                    </motion.div>
                ) : (
                    <motion.div
                    ...
                    >
                        ...
                        <p className="text-zinc-400 mb-8">
                            Nous avons bien reçu votre demande. Notre équipe vous recontacte sous 24h.
                        </p>
