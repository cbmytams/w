 ...
 */
export type BrandPillarKey = 'STRATEGY' | 'CONTENT' | 'ACTIVATION' | 'DATA' | 'ORGANIZATION';
 ...
 */
export type QuestionType = 'single' | 'multiple' | 'scale' | 'text' | 'email' | 'tel' | 'url' | 'dropdown';
...
export type NorthStarObjective = 'awareness' | 'traffic' | 'conversion' | 'retention' | 'unknown';

// ============================================
// ÉTAT DU DIAGNOSTIC
// ============================================

export type DiagnosticPhase = 'landing' | 'quick_lead' | 'deep_qualification' | 'results' | 'contact' | 'admin';
...
export interface LeadRecord {
    ...
    email?: string;
    phone?: string;
    status: 'NEW' | 'IN_PROGRESS' | 'COMPLETED' | 'QUALIFIED' | 'INTERVIEW' | 'REJECTED' | 'ARCHIVED';
    priority: 'P1' | 'P2' | 'P3';
    slaState: 'ON_TIME' | 'AT_RISK' | 'LATE';
    ownerId?: string;
    createdAt: string;
