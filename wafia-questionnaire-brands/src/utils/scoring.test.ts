        ...
        const questions: Question[] = [
            {
                ...
                question: 'Q1',
                options: [
                    { id: 'a', label: 'A', impacts: [{ pillar: 'STRATEGY', weight: 10 }] },
                    { id: 'b', label: 'B', impacts: [{ pillar: 'STRATEGY', weight: -5 }] }
                ]
            },
            {
                id: 'q2',
        ...
        const questions: Question[] = [
            {
                ...
                question: 'Q4',
                options: [
                    { id: 'hi', label: 'High', impacts: [{ pillar: 'STRATEGY', weight: 999 }] },
                    { id: 'lo', label: 'Low', impacts: [{ pillar: 'STRATEGY', weight: -999 }] }
                ]
            }
        ];
