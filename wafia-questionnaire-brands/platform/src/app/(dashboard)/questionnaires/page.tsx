...
export const metadata: Metadata = {
  ...
  description:
    "Pilotage des versions de questionnaires et suivi de complétion.",
};
    ...
    <div className="space-y-6">
      <div className="surface-card p-6">
        ...
        <p className="text-sm text-muted mt-2">
          Créez des versions, suivez la complétion et adaptez les champs
          obligatoires.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="surface-card p-6">
          ...
          <div className="text-sm text-muted">
            V1 • 32 questions • 78% complétion moyenne
          </div>
        </div>
        <div className="surface-card p-6">
          <h2 className="text-lg font-semibold mb-4">Champs manquants</h2>
          <div className="text-sm text-muted">
            Contact direct • Rate card • Disponibilités
          </div>
        </div>
      </div>
    </div>
