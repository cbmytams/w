...
export const metadata: Metadata = {
  ...
  description:
    "Base talents centralisée avec recherche, filtres et suivi de statut.",
};
    ...
    <div className="space-y-6">
      <div className="surface-card p-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          <div className="rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 px-4 py-2 text-xs text-muted">
            Plateforme
          </div>
          <div className="rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 px-4 py-2 text-xs text-muted">
            Catégorie
          ...
          <div className="min-w-[720px]">
            ...
            <div className="divide-y divide-white/5">
              {talents.map((talent) => (
                <div
                  key={talent.name}
                  className="grid grid-cols-5 text-sm py-4"
                >
