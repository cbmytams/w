...
export const metadata: Metadata = {
  ...
  description:
    "Vue d'ensemble des KPIs, alertes et activités de la plateforme talents.",
};
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="surface-card p-6 lg:col-span-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-soft uppercase tracking-[0.3em]">
              24h
            </span>
          </div>
        ...
        <div className="surface-card p-6">
          ...
          <div className="mt-4 space-y-3 text-sm text-muted">
            {alerts.map((alert) => (
              <div
                key={alert}
                className="rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 px-4 py-3"
              >
                {alert}
              </div>
            ))}
